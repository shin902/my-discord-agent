...
def build_search_query(query: str, from_date: str | None, to_date: str | None) -> str:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Search arXiv and print normalized JSON")
    ...
    try:
        search_query = build_search_query(args.query, args.from_date, args.to_date)
    except ValueError as exc:
