...
| `config/groups.json` | Yes | チャンネル、group/channelのAgentConfig（model、tools、approvalRequiredTools、skills、mounts、contextFiles）などの設定 |
