...
const calendarEventParameters = {
  ...
  calendarId: calendarIdDescription,
} as const;
...
const ENGLISH_TOOL_SCHEMAS: Readonly<Record<string, ToolSchemaDescriptions>> = {
  ...
  read: {
    ...
    parameters: {
      ...
      startLine: "1-based line number to start reading from, through EOF unless lineCount is also set.",
      lineCount: "Number of lines to return. If startLine is omitted, reading starts at the beginning.",
      tailCount: "Number of lines to return from the end. Cannot be combined with startLine or lineCount.",
    },
  },
  write: {
    description: "Create or overwrite a file in the workspace or an additional mounted path.",
    parameters: {
  ...
  list: {
    description: "List files and directories in the workspace or an additional mounted path.",
    parameters: {
  ...
  "list-emails": {
    ...
    parameters: {
      ...
      folder: "Mail folder name such as inbox, sentitems, or drafts. Defaults to inbox.",
  ...
  "clone-repository": {
    ...
    parameters: {
      ...repositoryParameters,
      directory: "Destination directory. Defaults to /tmp/{repo}; only paths relative to /tmp are allowed.",
      depth: "History depth for a shallow clone. Must be a positive integer; omit it to clone full history.",
    },
  },
  "list-calendars": {
    description:
  ...
  "list-events": {
    ...
    parameters: {
      timeMin: "Start of the time range in ISO 8601 format. Defaults to the current time.",
  ...
  "browserless-smart-scrape": {
    ...
    parameters: {
      url: "URL to scrape.",
      formats: 'Output formats such as html, markdown, screenshot, pdf, or links. Defaults to ["markdown"].',
    },
  },
  "browserless-search": {
    ...
    parameters: {
      ...
      sources: 'Search sources such as web, news, or images. Defaults to ["web"].',
    },
  },
  ...
  "tavily-search": {
    ...
    parameters: {
      ...
      search_depth: "Search depth: basic is faster, advanced is more detailed but slower. Defaults to basic.",
      include_answer: "Whether to include an AI-generated answer summary. Defaults to true.",
  ...
  "tavily-extract": {
    ...
    parameters: {
      ...
      extract_depth: "Extraction depth: basic is faster, advanced is more detailed but slower. Defaults to basic.",
  ...
  "tavily-crawl": {
    ...
    parameters: {
      ...
      max_breadth: "Number of links to follow per page, from 1 to 500. Defaults to 20.",
      limit: "Maximum total number of pages to process. Defaults to 50.",
      instructions: "Natural-language instructions used to narrow the crawl target.",
      select_paths: "Regular expression patterns used to limit crawled URL paths.",
  ...
  "tavily-map": {
    ...
    parameters: {
      ...
      instructions: "Natural-language instructions used to narrow the mapping target. Using this option doubles the cost.",
  ...
  "get-current-weather": {
    ...
    parameters: {
      location: "Place name whose current weather should be fetched, for example Tokyo or Osaka.",
    },
  },
  "get-weather-forecast": {
    ...
    parameters: {
      location: "Place name whose weather forecast should be fetched, for example Tokyo or Osaka.",
  ...
  bot: {
    ...
    parameters: {
      bot: "Bot ID to use.",
      prompt: "Task or request to send to the Bot.",
      session: "Task Session handle to resume.",
    },
  },
  subagent: {
    description:
    ...
    parameters: {
      task: "Self-contained task to delegate to the subagent.",
    },
  },
};
...
export function applyEnglishToolSchema<T extends AgentTool>(tool: T): T {
  ...
  (tool as AgentTool).description = english.description;
