...
type GraphTokenCache = Pick<
  ReturnType<PublicClientApplication["getTokenCache"]>,
  "getAllAccounts" | "serialize" | "deserialize" | "removeAccount"
>;
export type GraphAuthClient = Pick<
  PublicClientApplication,
  "acquireTokenSilent" | "acquireTokenByDeviceCode"
> & {
